...
JOIN (VALUES
  -- 1回目: 未申請 🟠残5日 / 2回目: —
  ('サンプル：今週期限工業', '【CU】1回目未申請・7日以内', '2025-12-20', 15, false, '未申請', NULL,      '【全状況】1回目🟠'),
  -- 1回目: 申請済 / 2回目: 重点・未申請
  ('サンプル：全状況デモ株式会社', '【CU】1回目申請済',       '2025-10-01', 25, true,  '申請済', '未申請', '【全状況】1回目申請済・2回目待ち'),
  -- 1回目: 承認済 ✅ / 2回目: 申請済
  ('サンプル：全状況デモ株式会社', '【CU】2回目申請済',       '2025-06-01', 10, true,  '承認済', '申請済', '【全状況】2回目申請済'),
  -- 1回目: 不承認
  ('サンプル：全状況デモ株式会社', '【CU】1回目不承認',       '2025-08-01', 20, false, '不承認', NULL,     '【全状況】1回目不承認'),
  -- 1回目: 🔴期限切れ
  ('サンプル：期限切れ商事',       '【CU】1回目期限切れ',       '2024-03-01', 25, false, '未申請', NULL,     '【全状況】1回目🔴'),
  -- 1回目: 承認済 / 2回目: 承認済 ✅
  ('サンプル：余裕ありサービス',   '【CU】両方承認済',         '2024-01-01', 15, true,  '承認済', '承認済', '【全状況】完了'),
  -- 1回目: 承認済 / 2回目: 不承認
  ('サンプル：全状況デモ株式会社', '【CU】2回目不承認',       '2025-04-01', 10, true,  '承認済', '不承認', '【全状況】2回目不承認'),
  -- 1回目: 未申請 🟢余裕
  ('サンプル：余裕ありサービス',   '【CU】1回目余裕あり',     '2026-01-15', 25, false, '未申請', NULL,     '【全状況】1回目🟢')
